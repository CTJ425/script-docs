...
| **Claude Code 用量狀態列**<br>模型 + 5h / 每週用量 + context window | `curl -fsSL https://raw.githubusercontent.com/CTJ425/script-docs/main/claudecode/usage_hub/install.sh \| bash` |
...
| 🤖 [claudecode/usage_hub](./claudecode/usage_hub) | Claude Code 狀態列：模型名稱、5h / 每週用量、context window，含冷啟動快取 |
